...
public class Painel_pve extends javax.swing.JDialog {

    int id = 0;
    String numero, nome, tipo1, tipo2;
    ControllerStatusDB statusDB = new ControllerStatusDB();

    public Painel_pve(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Painel_pve.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Painel_pve dialog = new Painel_pve(new javax.swing.JFrame(), true);
