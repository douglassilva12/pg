...
public class Con_PvE extends javax.swing.JInternalFrame {

    NewJInternalFrame iframe = new NewJInternalFrame(true);
    ...
    private void jButton1ConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ConsultarActionPerformed
        getParent().add(iframe);
        iframe.show();
        iframe.setClosable(true);
        iframe.setIconifiable(true);
        jTextField1ID.setText(String.valueOf(iframe.id));
    ...
    private void jTextField1IDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1IDKeyPressed
        if ((evt.getKeyCode() == KeyEvent.VK_ENTER) || (evt.getKeyCode() == KeyEvent.VK_TAB)) {
            if (jTextField1ID.getText().equals("")) {
                ...
                jTextField1ID.setText(String.valueOf(statusdb.getUltimoCodigo("tbstatus", "staid")));
                ...
                if (statusBanco.getId() > 0) {
                    ...
                    jTextField4ATK.setText(statusBanco.getAtk());
                    jTextField5DEF.setText(statusBanco.getDef());
                    jTextField6PS.setText(statusBanco.getSta());
