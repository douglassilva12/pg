...
import BancoDados.ControllerPvP500StatusDB;
...
import PainelPesquisa.Painel_pvp500;

public class Con_PvP_500 extends javax.swing.JInternalFrame {

    ControllerCpmDB cpmdb = new ControllerCpmDB();
    ControllerPvP500StatusDB pvp500db = new ControllerPvP500StatusDB();
    ControllerStatusDB statusdb = new ControllerStatusDB();
    ModelCpm cpmBanco = new ModelCpm();
    ModelPvP500Status pvp500Banco = new ModelPvP500Status();
    ModelStatus statusBanco = new ModelStatus();
    Painel_pvp500 iframe = new Painel_pvp500(null, true);
    ...
    private void initComponents() {
        ...
        setTitle("Filtro PvP 500");
        setPreferredSize(new java.awt.Dimension(610, 515));
    ...
    private void jTextField1IDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1IDKeyPressed
        if ((evt.getKeyCode() == KeyEvent.VK_ENTER) || (evt.getKeyCode() == KeyEvent.VK_TAB)) {
            if (jTextField1ID.getText().equals("")) {
                ...
                pvp500Banco = pvp500db.getPvP(id);
                statusBanco = statusdb.getStatus(id);
                if (statusBanco.getId() > 0) {
                    jTextField1ID.setText(String.valueOf(statusBanco.getId()));
                    jTextField2Numero.setText(statusBanco.getNumero());
                    jTextField3Nome.setText(statusBanco.getNome());
                    preencher();
                    habilitaCampos(true);
                    jTextField2Numero.requestFocus();
                } else {
    ...
    public void preencher() {
        jTextField4Ranking1.setText(pvp500Banco.getRank1()); jTextField5ATK1.setText(pvp500Banco.getIndAtk1()); jTextField6DEF1.setText(pvp500Banco.getIndDef1()); jTextField7PS1.setText(pvp500Banco.getIndSta1()); jTextField8Level1.setText(pvp500Banco.getLevel1());
        jTextField4Ranking2.setText(pvp500Banco.getRank2()); jTextField5ATK2.setText(pvp500Banco.getIndAtk2()); jTextField6DEF2.setText(pvp500Banco.getIndDef2()); jTextField7PS2.setText(pvp500Banco.getIndSta2()); jTextField8Level2.setText(pvp500Banco.getLevel2());
        jTextField4Ranking3.setText(pvp500Banco.getRank3()); jTextField5ATK3.setText(pvp500Banco.getIndAtk3()); jTextField6DEF3.setText(pvp500Banco.getIndDef3()); jTextField7PS3.setText(pvp500Banco.getIndSta3()); jTextField8Level3.setText(pvp500Banco.getLevel3());
        jTextField4Ranking4.setText(pvp500Banco.getRank4()); jTextField5ATK4.setText(pvp500Banco.getIndAtk4()); jTextField6DEF4.setText(pvp500Banco.getIndDef4()); jTextField7PS4.setText(pvp500Banco.getIndSta4()); jTextField8Level4.setText(pvp500Banco.getLevel4());
        jTextField4Ranking5.setText(pvp500Banco.getRank5()); jTextField5ATK5.setText(pvp500Banco.getIndAtk5()); jTextField6DEF5.setText(pvp500Banco.getIndDef5()); jTextField7PS5.setText(pvp500Banco.getIndSta5()); jTextField8Level5.setText(pvp500Banco.getLevel5());
        jTextField4Ranking6.setText(pvp500Banco.getRank6()); jTextField5ATK6.setText(pvp500Banco.getIndAtk6()); jTextField6DEF6.setText(pvp500Banco.getIndDef6()); jTextField7PS6.setText(pvp500Banco.getIndSta6()); jTextField8Level6.setText(pvp500Banco.getLevel6());
        jTextField4Ranking7.setText(pvp500Banco.getRank7()); jTextField5ATK7.setText(pvp500Banco.getIndAtk7()); jTextField6DEF7.setText(pvp500Banco.getIndDef7()); jTextField7PS7.setText(pvp500Banco.getIndSta7()); jTextField8Level7.setText(pvp500Banco.getLevel7());
        jTextField4Ranking8.setText(pvp500Banco.getRank8()); jTextField5ATK8.setText(pvp500Banco.getIndAtk8()); jTextField6DEF8.setText(pvp500Banco.getIndDef8()); jTextField7PS8.setText(pvp500Banco.getIndSta8()); jTextField8Level8.setText(pvp500Banco.getLevel8());
        jTextField4Ranking9.setText(pvp500Banco.getRank9()); jTextField5ATK9.setText(pvp500Banco.getIndAtk9()); jTextField6DEF9.setText(pvp500Banco.getIndDef9()); jTextField7PS9.setText(pvp500Banco.getIndSta9()); jTextField8Level9.setText(pvp500Banco.getLevel9());
        jTextField4Ranking10.setText(pvp500Banco.getRank10()); jTextField5ATK10.setText(pvp500Banco.getIndAtk10()); jTextField6DEF10.setText(pvp500Banco.getIndDef10()); jTextField7PS10.setText(pvp500Banco.getIndSta10()); jTextField8Level10.setText(pvp500Banco.getLevel10());
    ...
    public void limpaCampos() {
        ...
        jTextField5ATK1.setText("");
        jTextField6DEF1.setText("");
        jTextField7PS1.setText("");
    }

    DecimalFormat df = new DecimalFormat("0");
    public void calculo1() {
        double level = (Double.parseDouble(jTextField8Level1.getText()) * 2);
        int ba = Integer.parseInt(statusBanco.getAtk());
        int bd = Integer.parseInt(statusBanco.getDef());
        int bs = Integer.parseInt(statusBanco.getSta());
